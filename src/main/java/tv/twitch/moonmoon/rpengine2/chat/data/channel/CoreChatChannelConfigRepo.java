...
@Singleton
public class CoreChatChannelConfigRepo implements ChatChannelConfigRepo {
    ...
    @Inject
    public CoreChatChannelConfigRepo(ChatChannelConfigDbo configDbo, @PluginLogger Logger log) {
