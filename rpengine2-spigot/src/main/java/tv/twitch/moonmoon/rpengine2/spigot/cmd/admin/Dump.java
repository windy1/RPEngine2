...
public class Dump {
    ...
    public boolean handle(CommandSender sender, String[] args) {
        ...
        switch (args[0]) {
            case "player":
            case "p":
                return handleDumpPlayer(sender, tv.twitch.moonmoon.rpengine2.util.StringUtils.splice(args, 1));
            case "players":
            case "ps": {
            ...
            case "attribute":
            case "at":
                return handleDumpAttribute(sender, tv.twitch.moonmoon.rpengine2.util.StringUtils.splice(args, 1));
            case "attributes":
            case "ats": {
            ...
            case "select":
            case "sel":
                return handleDumpSelect(sender, tv.twitch.moonmoon.rpengine2.util.StringUtils.splice(args, 1));
            case "channels":
            case "chans":
                return handleDumpChannels(sender);
            case "channel":
            case "chan":
                return handleDumpChannel(sender, tv.twitch.moonmoon.rpengine2.util.StringUtils.splice(args, 1));
            case "channelconfigs":
            case "chanconfigs":
                return handleDumpChannelConfigs(sender);
            case "channelconfig":
            case "chanconfig":
                return handleDumpChannelConfig(sender, tv.twitch.moonmoon.rpengine2.util.StringUtils.splice(args, 1));
            case "chatconfig":
                return handleDumpChatConfig(sender, tv.twitch.moonmoon.rpengine2.util.StringUtils.splice(args, 1));
            case "chatconfigs":
