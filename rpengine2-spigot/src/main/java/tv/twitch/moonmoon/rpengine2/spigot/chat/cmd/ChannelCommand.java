...
import tv.twitch.moonmoon.rpengine2.spigot.chat.cmd.parser.CommandChatConfigParser;
...
public class ChannelCommand extends AbstractCoreCommandExecutor {
    ...
    public boolean handle(CommandSender sender, String[] args) {
        ...
        switch (args[0]) {
            case "mute":
            case "unmute":
                return handleMute(sender, tv.twitch.moonmoon.rpengine2.util.StringUtils.splice(args, 1));
            case "join":
            case "j":
    ...
    private boolean handleMute(CommandSender sender, String[] args) {
        ...
        ((SpigotChat) chat).toggleMutedAsync(player, channel, sender);
