...
@Singleton
public class SpigotSelectRepoImpl implements SpigotSelectRepo {

    private final SpigotSelectDbo selectDbo;
    private final AttributeRepo attributeRepo;
    private final Logger log;
    private Map<String, Select> selects;

    @Inject
    public SpigotSelectRepoImpl(
        SelectDbo selectDbo,
        AttributeRepo attributeRepo,
        @PluginLogger Logger log
    ) {
        this.selectDbo = (SpigotSelectDbo) Objects.requireNonNull(selectDbo);
